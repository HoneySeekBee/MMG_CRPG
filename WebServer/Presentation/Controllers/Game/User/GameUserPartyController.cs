...
namespace Presentation.Controllers.Game.User
{
    ...
    public class GameUserPartyController : ControllerBase
    {
        private readonly IUserPartyRepository _repo;
        private readonly ILogger<GameUserPartyController> _logger;

        public GameUserPartyController(IUserPartyRepository repo, ILogger<GameUserPartyController> logger)
        {
            _repo = repo;
            _logger = logger;
        }
