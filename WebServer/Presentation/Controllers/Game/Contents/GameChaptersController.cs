...
namespace Presentation.Controllers.Game.Contents
{
    [ApiController]
    [Route("api/pb/chapters")]
    [Produces("application/x-protobuf")]
    public class GameChaptersController : ControllerBase
    {
        private readonly IChapterCache _chapterCache;

        public GameChaptersController(IChapterCache chapterCache)
        {
