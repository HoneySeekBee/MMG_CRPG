...
namespace Presentation.Controllers.Game
{
    ...
    public sealed class GameCharacterModelController : ControllerBase
    {
        private readonly ICharacterModelRepository _repo;
        private readonly ICharacterModelCache _cache;

        public GameCharacterModelController(ICharacterModelRepository repo, ICharacterModelCache cache)
        {
            _repo = repo;
            _cache = cache;
        }
