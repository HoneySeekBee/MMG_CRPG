...
namespace Presentation.Controllers.Admin.User
{
    ...
    public class AdminUserPartyController : ControllerBase
    {
        ...
        private readonly ILogger<AdminUserPartyController> _logger;

        public AdminUserPartyController(IUserPartyRepository repo, ILogger<AdminUserPartyController> logger)
        {
            _repo = repo;
            _logger = logger;
        }
