...
namespace Presentation.Controllers.Admin
{
    ...
    public sealed class AdminSkillLevelsController : ControllerBase
    {
        private readonly ISkillLevelService _svc;
        private readonly ILogger<AdminSkillLevelsController> _logger;

        public AdminSkillLevelsController(ISkillLevelService svc, ILogger<AdminSkillLevelsController> logger)
        {
            _svc = svc;
            _logger = logger;
        }
