...
namespace Presentation.Controllers.Admin
{
    ...
    public sealed class AdminCharacterController : ControllerBase
    {

        private readonly ICharacterService _svc;
        private readonly ILogger<AdminCharacterController> _logger;

        public AdminCharacterController(ICharacterService svc, ILogger<AdminCharacterController> logger)
        {
            _svc = svc;
            _logger = logger;
        }
