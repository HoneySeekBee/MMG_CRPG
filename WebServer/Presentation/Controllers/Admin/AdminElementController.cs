...
namespace Presentation.Controllers.Admin
{
    ...
    public class AdminElementController : ControllerBase
    {
        ...
        private readonly ILogger<AdminElementController> _logger;
        public AdminElementController(IElementService svc, IElementRepository repo, ILogger<AdminElementController> logger)
        {
