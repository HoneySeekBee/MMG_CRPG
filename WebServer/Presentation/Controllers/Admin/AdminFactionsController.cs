...
namespace Presentation.Controllers.Admin
{
    ...
    public sealed class AdminFactionsController : ControllerBase
    {
        private readonly IFactionService _svc;
        private readonly ILogger<AdminFactionsController> _logger;
        public AdminFactionsController(IFactionService svc, ILogger<AdminFactionsController> logger)
        {
